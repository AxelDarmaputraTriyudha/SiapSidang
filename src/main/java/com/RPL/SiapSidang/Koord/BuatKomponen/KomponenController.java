...
public class KomponenController {
    ...
    public String index2(
        ...
        for (int i = 0; i < deskripsiList.size(); i++) {
            ...
            int penguji = Integer.parseInt(pengujiList.get(i));
            int pembimbing = Integer.parseInt(pembimbingList.get(i));
    
            sumPenguji += penguji;
            sumPembimbing += pembimbing;
    
            System.out.println("Deskripsi: " + deskripsi + ", Penguji: " + penguji + ", Pembimbing: " + pembimbing);
        }
